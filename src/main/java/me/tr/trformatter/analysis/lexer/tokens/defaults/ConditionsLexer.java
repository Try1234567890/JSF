...
import me.tr.trformatter.analysis.lexer.tokens.OperatorToken;
...
public class ConditionsLexer extends GenericLexer {

    public ConditionsLexer(IndexedRawPlaceholder rawComponent, Characters characters) {
        super(rawComponent, characters);
    }

    public ConditionsLexer(IndexedRawPlaceholder rawComponent) {
        super(rawComponent);
    }
    ...
    @Override
    public ConditionToken tokenize() {
        IndexedRawConditions rawConditions = rawComponent().conditions();
