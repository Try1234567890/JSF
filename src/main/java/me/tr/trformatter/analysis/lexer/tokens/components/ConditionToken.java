...
import me.tr.trformatter.analysis.lexer.tokens.params.HasParams;
...
import me.tr.trformatter.analysis.lexer.tokens.params.manager.ParamsMapper;

import java.util.List;

public class ConditionToken implements Token, HasParams {
